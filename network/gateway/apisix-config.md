...
参考：[apisix/config-default.yaml at master · apache/apisix · GitHub](https://github.com/apache/apisix/blob/master/conf/config-default.yaml)
...
参考：[apisix-ingress-controller/config-default.yaml at master · apache/apisix-ingress-controller · GitHub](https://github.com/apache/apisix-ingress-controller/blob/master/conf/config-default.yaml)
...
参考：[apisix-dashboard/conf.yaml at master · apache/apisix-dashboard · GitHub](https://github.com/apache/apisix-dashboard/blob/master/api/conf/conf.yaml)
